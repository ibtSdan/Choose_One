...
public class DuplicateVoteExceptionHandler {
    @ExceptionHandler(value = {DuplicateVoteException.class})
    public ResponseEntity<Api> duplicateVoteException(DuplicateVoteException e){
        log.error(""+e);
